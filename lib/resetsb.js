...
function removeSession(phone) {
    ...
    const folder = getSessionPath(normalized)
...
async function getWaVersion() {
    try {
        ...
        console.log(
            '[SUBBOT] No se pudo obtener la versión de WhatsApp Web.'
        )
    }
