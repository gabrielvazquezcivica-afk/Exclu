        ...
        sock.ev.on(
            ...
            async update => {
                ...
                if (
                    ...
                    console.log(
                        `[SUBBOT] +${normalized} perdió la sesión.`
                    )
...
export async function startSub() {
    ...
    console.log(
        `[SUBBOT] Se iniciaron ${reconnected} de ${folders.length} sesión(es).`
    )
...
export async function removeSubBot(phone) {
    const normalized =
        normalizePhone(
            phone
        )
